-- save_work passa a gravar apartamento e estado, agora que o endereço vem
-- separado em campos.
...
begin
  ...
  insert into public.works (
    id, user_id, street, unit, city, state, zip, code, service, description,
    observations, water_available, power_available, start_date, status,
    completed_at, position, company_id
  )
  values (
    v_work_id, v_user_id,
    payload ->> 'street',
