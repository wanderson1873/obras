-- Obra nova já nasce ligada à empresa de quem criou, para poder ser
-- compartilhada depois. O compartilhamento em si nunca é tocado aqui: quem
-- muda isso é set_work_sharing. Assim, salvar uma tarefa não mexe em quem vê.
